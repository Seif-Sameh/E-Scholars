    ...
    return (
        <section class="bg-white dark:bg-gray-900">
            <div class="container px-6 py-12 mx-auto">
                ...
                <img class="object-cover w-full h-64 mt-10 rounded-lg lg:h-96" src={image4} alt="" />
                ...
                <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3 sm:grid-cols-2 ">
                    <div class="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                        ...
                        <h2 class="mt-4 text-base font-medium text-gray-800 dark:text-white">E-mail us</h2>
                        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">If you have any questions.</p>
                    ...
                    <div class="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                        ...
                        <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">+20 106 195 3831</p>
                    </div>
                    ...
                    <div class="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                        ...
                        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Available all week.</p>
                        <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">+20 109 482 3779</p>
                    </div>
                </div>
            </div>
        </section>
